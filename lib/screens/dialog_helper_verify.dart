...
import 'package:token_cards_first/screens/ScanQRPageVerify.dart';
import 'package:token_cards_first/screens/EnterTokenIDVerifyPage.dart';

class DialogHelperVerify {
  ...
  TextButton(
    ...
    onPressed: () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const ScanQRPageVerify()),
      );
    },
  ...
  TextButton(
    ...
    onPressed: () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const EnterTokenIDVerifyPage()),
      );
    },
